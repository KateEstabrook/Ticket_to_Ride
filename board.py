...
TRAINS = {
    ("Montreal", "Boston"):[[(2252, 230, 220), (2320, 288, 220)],
                            [(2232, 256, 220), (2301, 313, 220)]],
    ("Boston", "New York"): [[(2320, 394, 123), (2273, 470, 123)],
                             [(2346, 414, 123), (2298, 488, 123)]],
    ("Montreal", "New York"): [[(2182, 280, 80), (2196, 367, 80), (2210, 456, 80)]],
    ("New York", "Washington"): [[(2262, 595, 85), (2270, 682, 85)],
                                 [(2234, 593, 85), (2240, 683, 85)]],
    ("Washington", "Raleigh"): [[(2226, 811, 130), (2170, 877, 130)],
                                [(2200, 792, 130), (2146, 856, 130)]],
    ("Raleigh", "Charleston"): [[(2163, 954, 35), (2205, 1014, 116)]],
    ("Charleston", "Miami"): [[(2183, 1137, 85), (2192, 1223, 80),
                               (2211, 1309, 70), (2247, 1390, 60)]],
    ("Miami", "Atlanta"): [[(2211, 1402, 48), (2152, 1335, 48), (2100, 1267, 48),
                            (2042, 1198, 48), (1990, 1130, 48)]],
    ("Miami", "New Orleans"): [[(2193, 1438, 45), (2130, 1377, 38),(2060, 1327, 30),
                                (1973, 1306, 0),(1887, 1317, -11),(1805, 1350, -28)]],
    ...
    ("Calgary", "Winnipeg"): [[(652, 191, 159),(734, 165, 168), (821, 153, 175),
                               (910, 155, 184), (998, 170, 194),(1080, 201, 202)]],
    ("Helena", "Duluth"): [[(903, 534, 0), (990, 533, 0), (1079, 531, 0),
                            (1167, 530, 0), (1255, 528, 0), (1343, 528, 0)]],
    ("Seattle", "Vancouver"): [[(278, 320, 90)], [(246, 320, 90)]],
    ("Portland", "Salt Lake City"): [[(276, 526, 192), (360, 550, 197), (440, 590, 210),
                                      (510, 641, 215), (576, 700, 228), (625, 776, 236)]],
    ("San Francisco", "Salt Lake City"): [[(248, 955, 163), (332, 927, 163), (412, 899, 163),
                                           (495, 873, 163), (576, 846, 163)],
                                          [(261, 982, 163),(343, 955, 163), (424, 928, 163),
                                           (504, 902, 163), (587, 874, 163)]],
    ("Seattle", "Helena"): [[(328, 433, 190), (416, 454, 190), (498, 470, 190),
                             (586, 489, 190), (670, 508, 190), (758, 528, 190)]],
    ("Seattle", "Portland"): [[(216,445, 110)], [(248, 453, 110)]],
    ("Salt Lake City", "Denver"): [[(723, 862, 11), (808, 878, 11), (891, 894, 11)],
                                   [(729, 833, 11), (814, 849, 11), (897, 865, 11)]],
    ("Salt Lake City", "Las Vegas"): [[(577, 1071, 138), (627, 996, 113), (649, 912, 99)]],
    ("El Paso", "Dallas"): [[(1054, 1358, 174), (1141, 1344, 174),
                             (1228, 1332, 174), (1314, 1319, 174)]],
    ("Helena", "Salt Lake City"): [[(701, 752, 120), (745, 678, 120), (789, 603, 120)]],
    ("San Francisco", "Los Angeles"): [[(217, 1050, 65), (260, 1128, 56), (315, 1195, 45)],
                                       [(192, 1068, 65), (235, 1146, 56), (290, 1211, 45)]],
    ...
    ("Denver", "Oklahoma City"): [[(1015, 988, 42), (1089, 1039, 26),
                                   (1173, 1062, 11), (1262, 1072, 2)]],
    ("Los Angeles", "Las Vegas"): [[(384, 1174, 117), (452, 1117, 170)]],
    ("Los Angeles", "Phoenix"): [[(423, 1230, 173), (509, 1225, 0), (598, 1236, 193)]],
    ("Los Angeles", "El Paso"): [[(424, 1296, 37), (499, 1340, 27), (582, 1369, 17),
                                  (669, 1385, 10), (759, 1390, 178), (844, 1376, 173)]],
    ("Santa Fe", "Oklahoma"): [[(1027, 1133, 170), (1115, 1123, 170), (1202, 1112, 170)]],
    ("Phoenix", "El Paso"): [[(715, 1288, 15), (798, 1312, 15), (883, 1337, 15)]],
    ("Phoenix", "Denver"): [[(680, 1202, 112), (719, 1127, 121), (765, 1051, 126),
                             (823, 988, 141), (901, 943, 158)]],
    ("Phoenix", "Santa Fe"): [[(731, 1230, 160), (812, 1195, 160), (893, 1159, 160)]],
    ("Helena", "Winnipeg"): [[(891, 474, 135), (952, 413, 135),
                              (1013, 350, 135), (1075, 287, 135)]],
    ("Duluth", "Winnipeg"): [[(1178, 290, 223), (1243, 352, 223),
                              (1305, 412, 223), (1367, 473, 223)]],
    ("Helena", "Omaha"): [[(924, 583, 25), (1004, 616, 25), (1086, 649, 25),
                           (1168, 682, 25), (1248, 716, 25)]],
    ("Calgary", "Helena"): [[(634, 273, 50), (688, 342, 50), (746, 408, 50), (802, 476, 50)]],
    ("Helena", "Denver"): [[(861, 600, 67), (893, 679, 67), (925, 760, 67), (958, 841, 67)]],
    ("Portland", "San Francisco"): [[(198, 579, 116), (171, 664, 103), (161, 752, 90),
                                     (163, 840, 85), (178, 926, 76)],
                                    [(165, 574, 116), (139, 659, 103), (128, 747, 90),
                                     (129, 835, 85), (146, 921, 76)]],
    ("New Orleans", "Atlanta"): [[(1760, 1324, 109), (1801, 1246, 119),
                                  (1853, 1174, 137), (1912, 1113, 137)],
                                 [(1736, 1300, 109), (1779, 1217, 125),
                                  (1830, 1150, 137), (1888, 1089, 137)]],
    ("Atlanta", "Raleigh"): [[(2006, 1033, 137), (2074, 973, 137)],
                             [(1989, 1006, 137), (2055, 948, 137)]],
    ("Montreal", "Toronto"): [[(2123, 234, 155), (2052, 279, 140), (1994, 352, 115)]],
    ("Toronto", "Pittsburgh"): [[(2007, 475, 87), (2014, 565, 87)]],
    ("Pittsburgh", "New York"): [[(2160, 534, 148), (2080, 582, 148)],
                                 [(2094, 610, 148), (2170, 565, 148)]],
    ...
    ("Montreal", "Sault St. Marie"): [[(2100, 193, 0), (2013, 202, -10), (1927, 226, -13),
                                       (1846, 262, 156), (1773, 312, 146)]],
    ...
    ("Nashville", "Pittsburgh"): [[(1819, 913, 120), (1863, 842, 132),
                                   (1935, 782, 148), (1999, 718, 125)]],
    ("Pittsburgh", "Saint Louis"): [[(1966, 685, 150), (1890, 730, 150), (1813, 772, 150),
                                     (1737, 817, 150), (1660, 862, 150)]],
    ("Saint Louis", "Nashville"): [[(1661, 926, 18), (1744, 952, 18)]],
    ("Saint Louis", "Little Rock"): [[(1588, 939, 104), (1570, 1023, 104)]],
    ("Pittsburgh", "Chicago"): [[(1954, 639, 5), (1866, 639, -7), (1779, 660, -15)],
                                [(1941, 600, 5), (1855, 609, -7), (1765, 625, -15)]],
    ("Toronto", "Sault St. Marie"): [[(1885, 392, 13), (1800, 373, 13)]],
    ("Toronto", "Duluth"): [[(1909, 439, -11), (1824, 451, -11), (1737, 465, -11),
                             (1650, 481, -11), (1564, 498, -11), (1476, 513, -11)]],
    ("Sault St. Marie", "Winnipeg"): [[(1653, 334, 13), (1566, 316, 13), (1482, 298, 13),
                                       (1395, 280, 13), (1311, 262, 13), (1222, 244, 13)]],
    ("Sault St. Marie", "Duluth"): [[(1656, 395, -22), (1575, 433, -22), (1494, 466, -22)]],
    ("Toronto", "Chicago"): [[(1948, 465, 145), (1870, 505, 162),
                              (1791, 543, 148), (1720, 602, 135)]],
    ("Chicago", "Saint Louis"): [[(1653, 728, 125), (1605, 804, 125)],
                                 [(1681, 742, 125), (1635, 815, 125)]],
    ("Duluth", "Omaha"): [[(1371, 588, 113), (1338, 674, 113)],
                          [(1399, 601, 113), (1368, 682, 113)]],
    ...
    ("Kansas City", "Saint Louis"): [[(1537, 885, 0), (1450, 886, 0)],
                                     [(1539, 849, 0), (1450, 853, 0)]],
    ("Kansas City", "Denver"): [[(1315, 878, 160), (1233, 906, 170),
                                 (1146, 916, -5), (1057, 915, 5)],
                                [(1317, 912, 160), (1233, 937, 170),
                                 (1144, 949, -5), (1057, 951, 5)]],
    ("Kansas City", "Oklahoma City"): [[(1369, 934, 109),(1344, 1017, 109) ],
                                       [(1401, 942, 109), (1374, 1027, 109)]],
    ...
    ("Houston", "El Paso"): [[(1425, 1434, -17), (1338, 1456, -10), (1251, 1462, 2),
                              (1164, 1452, 7), (1078, 1435, 17), (996, 1399, 30)]],
    ("El Paso", "Oklahoma City"): [[(1010, 1330, 165), (1092, 1296, 155),
                                    (1168, 1252, 150), (1237, 1197, 136), (1294, 1131, 128)]],
    ("Oklahoma City", "Dallas"): [[(1352, 1149, 82), (1362, 1234, 82)],
                                  [(1381, 1144, 82), (1393, 1231, 82)]]
}
