...
ROUTES = [("Vancouver", "Seattle", 1, "colorless"), ("Vancouver", "Seattle", 1, "colorless"),
          ...
          ("Kansas City", "Oklahoma City", 2, "colorless"), ("Oklahoma City", "Dallas", 2, "colorless"), 
          ("Oklahoma City", "Dallas", 2, "colorless"), ("Oklahoma City", "Little Rock", 2, "colorless"), 
          ("Dallas", "Houston", 1, "colorless"), ("Dallas", "Houston", 1, "colorless"),
          ("Dallas", "Little Rock", 2, "colorless"), ("Houston", "New Orleans", 2, "colorless"), 
          ("Sault St. Marie", "Montreal", 5, "black"), ("Sault St. Marie", "Toronto", 2, "colorless"),
