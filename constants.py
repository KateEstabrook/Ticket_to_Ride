...
ROUTES_LST = [("Vancouver", "Seattle", 1, "colorless"), ("Vancouver", "Seattle", 1, "colorless"),
          ...
          ("Chicago", "Toronto", 4, "white"), ("Chicago", "Saint Louis", 2, "white"),
          ("Chicago", "Saint Louis", 2, "green"), ("Chicago", "Pittsburgh", 3, "black"),
          ("Chicago", "Pittsburgh", 3, "orange"), ("Saint Louis", "Pittsburgh", 5, "green"),
